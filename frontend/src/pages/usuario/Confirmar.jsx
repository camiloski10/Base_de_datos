    ...
    return (
        <div className='flex w-full h-screen'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 md:flex-row mx-auto'>
                <h1 className='font-bold text-6xl uppercase text-center md:w-2/3 mx-auto'>Confirma tu cuenta y Comienza a Disfrutar <span className='text-sky-700'>De Nuestros Productos</span></h1><div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
                    {!cargando &&
                        <Alerta
                            alerta={alerta}
                        />
